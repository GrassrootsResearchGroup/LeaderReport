...
plot_survey_data(organizations_heardof, mode='yn', cutoff_threshold=0.2)+ggtitle("Question: Which of the following organizations have you heard of?",  
...
plot_survey_data(organization_combined_data, mode='yn', level_order=org_level_order, , cutoff_threshold=0.03)+ggtitle("Comparison of Organization\n Activity Participation and Preference",  subtitle=paste("sample size:", n_unique_responses)) +
